...
**🎵 One library, done well** — a Plex-style library that appears once you point a root folder at your music. More than one root folder is fine (all serving the same library, each freely named) — move an artist's owned albums between them from their own page, previewed and backgrounded like a scan.
